class Candidate {
  ...
  Candidate({
    ...
    required this.gradeKahim,
    required this.gradeWakahim,
...
var candidateList = [
  Candidate(
    ...
    gradeKahim: 'Semester 5',
    gradeWakahim: 'Semester 3',
    classKahim: 'Sistem Informasi-2',
    classWakahim: 'Sistem Informasi-4',
    divisionKahim: 'Dana & Usaha',
